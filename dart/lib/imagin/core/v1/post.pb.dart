...
class PostData extends $pb.GeneratedMessage {
  factory PostData({
    ...
    $core.Iterable<$1.ContentData>? content,
    $core.String? message,
    $2.Metadata? metadata,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PostData', package: const $pb.PackageName(_omitMessageNames ? '' : 'imagin.core.v1'), createEmptyInstance: create)
    ...
    ..pc<$1.ContentData>(4, _omitFieldNames ? '' : 'content', $pb.PbFieldType.PM, subBuilder: $1.ContentData.create)
  ...
  @$pb.TagNumber(4)
  $pb.PbList<$1.ContentData> get content => $_getList(3);
