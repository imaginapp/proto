...
class CommentData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommentData', package: const $pb.PackageName(_omitMessageNames ? '' : 'imagin.core.v1'), createEmptyInstance: create)
    ...
    ..aOM<$11.ContentData>(4, _omitFieldNames ? '' : 'content', subBuilder: $11.ContentData.create)
    ..aOS(5, _omitFieldNames ? '' : 'message')
    ..aOM<$12.Metadata>(6, _omitFieldNames ? '' : 'metadata', subBuilder: $12.Metadata.create)
  ...
  @$pb.TagNumber(4)
  $11.ContentData get content => $_getN(3);
  @$pb.TagNumber(4)
  set content($11.ContentData v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasContent() => $_has(3);
  @$pb.TagNumber(4)
  void clearContent() => $_clearField(4);
  @$pb.TagNumber(4)
  $11.ContentData ensureContent() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $12.Metadata get metadata => $_getN(5);
  @$pb.TagNumber(6)
  set metadata($12.Metadata v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMetadata() => $_has(5);
  @$pb.TagNumber(6)
  void clearMetadata() => $_clearField(6);
  @$pb.TagNumber(6)
  $12.Metadata ensureMetadata() => $_ensure(5);
}
